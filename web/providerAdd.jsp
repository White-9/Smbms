...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form action="/addProvider" method="get" id="formAdd">
        ...
        proCode.blur(function () {
            $.ajax({
                ...
                success:function (data) {
                    if(data.proCode=="exit"){
                        proCode.next().html("供应商编号已存在");
                        proCode.next().css("color","red");
                        proCode.attr("status","false");
                    }else {
                        proCode.next().html("请添加新的供应商编号");
                        proCode.next().css("color","green");
                        proCode.attr("status","true");
                    }
                }
